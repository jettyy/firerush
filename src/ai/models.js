...
export const MODELS = [
  ...
  {
    id: 'claude-opus-5',
    label: 'Opus 5 — 가장 똑똑함 (글 품질 우선)',
    note: '같은 주제로 재보니 Sonnet 5 보다 분량 28%, 출처 50% 더 나왔고 '
      + '실패담과 출처를 문장 안에 자연스럽게 녹였습니다. 구독 사용량은 더 씁니다.',
  },
  {
    id: 'claude-sonnet-5',
    label: 'Sonnet 5 — 균형 (속도와 품질 중간)',
    note: '품질 검사는 Opus 와 똑같이 통과합니다. 표의 행을 채우는 데는 차이가 없어 '
      + '"표의 행을 채울 모델" 기본값입니다.',
  },
  {
    id: 'claude-haiku-4-5',
    label: 'Haiku 4.5 — 가장 빠름',
    note: '속도가 최우선일 때. 긴 글이나 복잡한 표에는 약합니다.',
  },
  {
    id: 'claude-fable-5-1',
